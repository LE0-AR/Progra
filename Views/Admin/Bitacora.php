...
<head>
    ...
    <style>
        ...
        /* ----- ANCHOS DE COLUMNAS PERSONALIZADOS ----- */
        #tablaBitacora th:nth-child(1) {
            width: 4%;
        }

        /* Columna No */
        #tablaBitacora th:nth-child(2) {
            width: 15%;
        }

        /* Columna Colaborador */
        #tablaBitacora th:nth-child(3) {
            width: 12%;
        }

        /* Columna ODT */
        #tablaBitacora th:nth-child(4) {
            width: 10%;
        }

        /* Columna Fecha */
        #tablaBitacora th:nth-child(5) {
            width: 6%;
        }

        /* Columna Horas */
        /* La columna 6 (Descripción) no necesita ancho, tomará el espacio sobrante */
        #tablaBitacora th:nth-child(7) {
            width: 160px;
        }
        ...
        @media (max-width: 900px) {
            ...
            #tablaBitacora th:nth-child(3),
            #tablaBitacora td:nth-child(3),
            #tablaBitacora th:nth-child(5),
            #tablaBitacora td:nth-child(5) {
                display: none;
            }
        ...
        @media (max-width: 600px) {
            ...
            #tablaBitacora th:nth-child(4),
            #tablaBitacora td:nth-child(4),
            #tablaBitacora th:nth-child(7),
            #tablaBitacora td:nth-child(7) {
                display: none;
            }
